...
class NounVerb extends \atoum
{
    public function test_noun_verb()
    {
        ...
        $intcodeProgram = new \Klnjmm\Day02\IntcodeProgram();

        $this->integer($this->newTestedInstance($intcodeProgram)->calculate($input, 19690720))->isEqualTo(7195);
    }
}
