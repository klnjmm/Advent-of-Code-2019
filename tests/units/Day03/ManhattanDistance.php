...
use Klnjmm\Day03\WirePathInterface;

class ManhattanDistance extends \atoum
{
    public function test_manhattan_distance()
    {
        $wirePath1 = $this->newMockInstance(WirePathInterface::class);
        $wirePath2 = $this->newMockInstance(WirePathInterface::class);

        $this->calling($wirePath1)->toGridPoints = [
        ...
        $this->calling($wirePath2)->toGridPoints = [
